from tkinter import *
from word_tone import word_color_thieft
...
class Application(Frame):
	...
	def pressed_enter(self, e):
		...
		for word in text_list:
			...
			self.last_word = self.color_field.create_text(x, y, font=self.default_font, text=word, fill="#%02x%02x%02x" % word_color_thieft(word, save_image=False))
			...
			processed_count += 1
			print(str(processed_count) + "/" + str(len(text_list)))
